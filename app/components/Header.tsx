        ...
        <div className="flex items-center justify-between gap-3 lg:justify-start">
          ...
          <Link href="/about" className="group flex items-center gap-3" onClick={() => setMobileMenuOpen(false)}>
            <motion.div
              ...
              className="relative isolate h-10 w-10 rounded-full border border-(--header-border) shadow-sm transition-[border-color,transform] duration-200 ease-out transform-gpu sm:h-12 sm:w-12"
            >
              <div className="absolute inset-0 overflow-hidden rounded-full">
                <PrefixedImage
                  ...
                  width={48}
                  height={48}
                  className="h-full w-full scale-100 object-cover transform-gpu transition-[filter,transform] duration-250 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-103 group-hover:saturate-110 dark:group-hover:saturate-125"
                />
              </div>
            </motion.div>
