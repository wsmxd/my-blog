...
export default function Header() {
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-sm border-b border-slate-700/50 transition-colors duration-300"
    >
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-4 sm:space-x-6 text-sm">
          <Link
            href="/blog"
            className="text-slate-400 hover:text-blue-400 transition-colors relative group text-base sm:text-lg"
          >
            博客
