  ...
  return (
    <div className="flex flex-nowrap items-center gap-1.5 overflow-hidden">
      {displayTags.map((tag, index) => (
        <span
          key={index}
          className="inline-flex shrink-0 items-center whitespace-nowrap px-2.5 py-1 text-xs font-medium rounded-md border border-(--tag-border) bg-(--tag-bg) text-(--tag-text) hover:bg-(--tag-bg-hover) transition-all duration-300"
        >
